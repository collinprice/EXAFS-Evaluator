...
int main(int argc, char **argv) {
	...
	if (ga_config.getString("eval-type").compare("solo") == 0) {
		...
		EXAFSPSO pso(exafs_evaluator, ga_config.getDouble("mutation"), ga_config.getDouble("crossover"), ga_config.getBool("elitism"), ga_config.getInt("max-generations"), ga_config.getString("results"));
